#ifndef TINY_OS_FILESYS_AFS_AFS_STORAGE_H
#define TINY_OS_FILESYS_AFS_AFS_STORAGE_H
...
STATIC_ASSERT(sizeof(struct afs_file_node_index) == AFS_BLOCK_BYTE_SIZE,
             invalid_sizeof_afs_file_node_index);
...
#define AFS_FILE_ENTRY_FLAG_IS_INDEX  0b00001; /* sector指向的是内容块还是索引块 */

#define AFS_FILE_ENTRY_FLAG_TYPE_MASK 0b01110; /* 类型mask，取值见AFS_FILE_TYPE_XXX */

#define AFS_FILE_ENTRY_FLAG_OPR_LOCK  0b10000; /* 操作锁，自旋 */

/* 文件类型取值：常规文件 */
#define AFS_FILE_TYPE_REGULAR (1 << 1)

/* 文件类型取值：目录 */
#define AFS_FILE_TYPE_DIRECTORY (2 << 1)

#endif /* TINY_OS_FILESYS_AFS_AFS_STORAGE_H */
