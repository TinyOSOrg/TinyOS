...
void afs_read_sector(uint32_t sec, size_t offset, size_t size, void *data);

void afs_write_sector(uint32_t sec, size_t offset, size_t size, const void *data);

void afs_read_block(uint32_t beg, size_t offset, size_t size, void *data);

void afs_write_block(uint32_t beg, size_t offset, size_t size, const void *data);
